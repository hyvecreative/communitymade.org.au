...
<!-- begin storypost -->
               ...
               <div class="col-md-4 feedcont text-left" style="display:flex; ">
                                ...
                                <div>
                                    ...
                                    <?php           
                $product_terms = wp_get_object_terms( $post->ID,  'journalism_categories' );
if ( ! empty( $product_terms ) ) {
	if ( ! is_wp_error( $product_terms ) ) {
			foreach( $product_terms as $term ) {
				echo '<a class="' . $term->slug .'" href="' . get_term_link( $term->slug, 'journalism_categories' ) . '">' . esc_html( $term->name ) . '</a> '; 
			}
