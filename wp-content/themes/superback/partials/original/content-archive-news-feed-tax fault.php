...
$args = array(
    ...
    'date_query' => array(
        array(
            'after' => '1 year ago', // Modify this to change the date range if needed
        ),
    ),
...
if ( $query->have_posts() ) {
    ...
    while ( $query->have_posts() ) {
        ...
        $custom_taxonomies = get_the_terms( get_the_ID(), 'your_custom_taxonomy' ); // Replace 'your_custom_taxonomy' with your actual taxonomy name
