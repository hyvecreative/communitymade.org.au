...
function theme_enqueue_assets() {
    ...
    wp_enqueue_script('flexmenu',       $js_dir . 'jquery.flexmenu.js', ['jquery'], null, true);
    wp_enqueue_script('scrollTo',       $js_dir . 'jquery.scrollTo.js', ['jquery'], null, true);
    wp_enqueue_script('fancyboxeasing', $js_dir . 'jquery.easing-1.3.pack.js', ['jquery'], null, true);
    wp_enqueue_script('scroll',         $js_dir . 'scroll.js',          ['jquery'], null, true);
    wp_enqueue_script('newsFilter',     $js_dir . 'custom-filters-news.js', ['jquery'], null, true);
