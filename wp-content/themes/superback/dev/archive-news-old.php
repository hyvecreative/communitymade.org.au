...
<?php get_header(); $enteredCat = htmlspecialchars($_GET["cat"]); $ID = 1974; ?>
	...
	<div class="container">
				...
				<ul class="basic-x">
					<li>
						<select name="categories" id="categories">
							...
							<?php
						    $categories = get_categories( array( 'taxonomy' => 'news_categories', 'orderby' => 'name', 'order' => 'ASC' ) );
		...
		<div class="row second-row">
			...
			<?php
			  ...
			  if ($queryCat != '') {
			    $args = array( 'post_type' => 'news', 'orderby' => 'date', 'order' => 'DESC', 'paged' => $paged,
												 'tax_query' => array( array( 'taxonomy' => 'news_categories', 'field'    => 'slug', 'terms' => $queryCat )));
			  } else {
			    $args = array( 'post_type' => 'news', 'orderby' => 'date', 'order' => 'DESC', 'paged' => $paged );
			  }
