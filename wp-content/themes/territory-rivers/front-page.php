...
<div class="container-fluid hm-pg-header" style="position: relative;">
		...
		<div class="row slider hm-feature-wrap">
            
            <?php if( have_rows('header_images') ): while ( have_rows('header_images') ) : the_row(); ?>

			<?php
					$image = get_sub_field('header_image_item');
		...
		<div class="row hm-feature">
            <div class="col col-lg-6 col-xl-5 hm-form">
		...
		<div class="row text-center">
			...
			<div class="row">
				<?php if( have_rows('threats') ): while ( have_rows('threats') ) : the_row(); ?>
					<div class="col-sm-6 col-md-6 col-lg-3 threat-icons">
