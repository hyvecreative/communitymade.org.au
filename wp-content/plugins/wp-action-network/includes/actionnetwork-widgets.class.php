...
class ActionNetwork_Signup_Widget extends WP_Widget {
	...
	public function processForm( $instance, $data = null ) {
        ...
        if($hcaptcha_site_key == null || $hcaptcha_secret_key == null || $instance['spam_protect'] == '') { //If no hCaptcha keys or no spam protection enabled, skip
            $spam_protect = false;
        } elseif($instance['spam_protect'] == 1) {
            $spam_protect = true;
        }
		...
		if($spam_protect){
            ...
            //Assume correct or no hCaptcha challenge
        }
